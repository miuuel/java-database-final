...
@Entity public class Customer { @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Long id;

    @Valid @NotNull(message = "El nombre no puede ser nulo") private String name; @NotNull(message = "El correo electrónico no puede ser nulo") private String email; @NotNull(message = "El número de teléfono no puede ser nulo") private String phone;
